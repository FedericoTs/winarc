...
const styles = StyleSheet.create({
  ...
  segText: { fontFamily: fonts.body, fontWeight: '600', fontSize: 13, color: colors.ink2 },
  ...
  tierValue: { fontFamily: fonts.display, fontWeight: '900', fontSize: 28, color: colors.ink },
