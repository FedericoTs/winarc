...
const styles = StyleSheet.create({
  ...
  big: { fontFamily: fonts.display, fontWeight: '900', textTransform: 'uppercase', lineHeight: 52, color: colors.ink },
  ...
  stampText: { fontFamily: fonts.display, fontWeight: '900', fontSize: 46, letterSpacing: 3, lineHeight: 46, textTransform: 'uppercase' },
